...
export const venueSlice = createSlice({
    ...
    reducers: {
        ...
        incrementQuantity: (state, action) => {
            ...
            // First checks if the item exists in the state at the provided index. If the item exists and it's an Auditorium Hall with a quantity greater than or equal to 3, it returns early without modifying the state.
        ...
        decrementQuantity: (state, action) => {
            const { payload: index } = action;
            // First checks if the item exists in the state at the provided index and if its quantity is greater than 0.
